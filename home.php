                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mr-3">
                                        ...
                                        <div class="text-lg font-weight-bold" style='height:65px'>
                                        	<?php 
                     ...
                     <div class="col-md-3">
                        <div class="card bg-info text-white mb-3">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mr-3">
                                        <div class="text-white-75 small">Loan Details</div>
                                        <div class="text-lg font-weight-bold">
                                            ...
                                            echo "<label class='text-dark'>Onging = </label>"." ".number_format($loans, 2)."<br>";
                                        	echo "<label class='text-dark'>Balance = </label>"." ".number_format($loans - $payments,2);
                                        	 ?>
