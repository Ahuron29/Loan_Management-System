<div class="container-fluid">
	...
	<div class="row">
	<div class="col-lg-12">
			<a class="btn btn-primary float-right btn-sm" id="new_user"><i class="fa fa-plus"></i> New user</a>
	</div>
	</div>
	<br>
	<div class="row">
		<div class="card col-lg-12">
			<small class="text-primary">Authorized Users</small>
			<div class="card-body">
	...
	<div class="row">
		<div class="card col-lg-12">
			<small class="text-primary">Registerd Client</small>
			<div class="card-body">
				<table class="table-striped table-bordered col-md-12">
			<thead>
				<tr>
					...
					<th class="text-center">Voters ID</th>
					<th class="text-center">Action</th>
				</tr>
			</thead>
			<tbody>
				<?php
 					include 'db_connect.php';
 					$users = $conn->query("SELECT * FROM client ");
 					$i = 1;
 					while($row= $users->fetch_assoc()):
				 ?>
				 <tr>
...
$('.edit_client').click(function(){
	uni_modal('Edit User','manage_client.php?id='+$(this).attr('data-id'))
})
