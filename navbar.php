...
<nav id="sidebar" class='mx-lt-5 bg-success' >
		...
		<div class="sidebar-list bg-primary">
				...
				<a href="index.php?page=plan" class="nav-item nav-plan"><span class='icon-field'><i class="fa fa-list-alt"></i></span> Loan Product</a>	
				...
				<a href="index.php?page=groups" class="nav-item nav-group"><span class='icon-field'><i class="fa fa-th-list"></i></span> Groups</a>		
