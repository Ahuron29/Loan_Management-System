...
?>
	<div class="row">
    <div class="col-lg-12">
        <a  style="margin-top:10px;" class="btn btn-primary float-right btn-sm" id="manage_profile"><i class="fa fa-user"></i> Update info here</a>
    </div>
    </div>
    <br>
    <div class="row">
    <div class="card col-lg-12">
                <div class="card-body">
                  <table class="table-striped table-bordered col-md-12">
                    ...
                    <tbody>
                      <td class="text-center col-md-6"><?php echo $row['name']  ?></td>
                      <td class="text-center col-md-6"><?php echo $row['username']  ?></td>
                    </tbody>
                  </table><br><br>
                  <table class="table-striped table-bordered col-md-12">
                    <thead>
                    ...
                    <tbody>
                      <td class="text-center col-md-6"><?php echo $row['email']  ?></td>
                      <td class="text-center col-md-6"><?php echo $row['voters_id']  ?></td>
                    </tbody>
                  </table><br><br>
                  <table class="table-striped table-bordered col-md-12">
                    <thead>
                    ...
                    <tbody>
                      <td class="text-center col-md-6"><?php echo '0'.$row['contact']  ?></td>
                      <td class="text-center col-md-6"><?php echo $row['address']  ?></td>
                    </tbody>
                  </table><br>
                </div>
            </div>
