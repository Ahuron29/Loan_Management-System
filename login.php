...
<main id="main" class="btn bg-success">
  	<large class="large">Adehyeman Savings and Loans Loan Management System</large>
  		...
  		<div id="login-right">
  			<div class="card col-md-8 bg-success">
			  	<div class="logo2">
			  		<span><img src="./assets/img/adehyeman-logo.jfif" alt=""></span>
				</div>
				<form id="login-form" >
						<div><h5 class="text-white">Authorized User Only</h5></div>
				...
				<div class="row">
					...
					<p class="mt-6 font-weight-normal">Client Login page <a  href="client_login.php"><button class="btn btn-primary float-right btn-sm new_user" >Client</button></a></p>
